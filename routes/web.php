...
// =============================== AKSES ADMIN, KURIR, OWNER, KASIR DAN PELANGGAN ===============================
Route::group(['middleware' => ['auth', 'checkRole:admin,kurir,owner,kasir,non_member,member']], function(){
// => Fitur Cari Halaman
...
// ===================================== AKSES ADMIN, OWNER, KASIR DAN KURIR =====================================
Route::group(['middleware' => ['auth', 'checkRole:admin,owner,kasir,kurir']], function(){
// => Halaman Profil

...
<body>
    ...
    <div id="main-wrapper">
                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        @if(auth()->user()->role == 'admin' || auth()->user()->role == 'kurir' || auth()->user()->role == 'owner' || auth()->user()->role == 'kasir')
                                        <li>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    @endif
                    @if(auth()->user()->role == 'admin' || auth()->user()->role == 'kurir' || auth()->user()->role == 'kasir')
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Laundry Putra Kembar</p>
            </div>
        </div>
    </div>
